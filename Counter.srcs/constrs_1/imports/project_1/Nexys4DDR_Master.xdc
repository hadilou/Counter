...
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports enable_pulse]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {C_out[0]}]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {C_out[1]}]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {C_out[2]}]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {C_out[3]}]
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { enable_pulse }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
